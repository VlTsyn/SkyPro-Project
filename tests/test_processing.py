...
@pytest.mark.parametrize("example, state, executed",
                         [([{'id': 41428829,'date': '2019-07-03T18:35:29.512364'}], '', 'Отсутствует статус'),
                          ([{'id': 41428829, 'state': 'MARKED', 'date': '2019-07-03T18:35:29.512364'}],
                           '','Отсутствует статус'),
                          ([{'id': 41428829, 'state': 'PENDING', 'date': '2019-07-03T18:35:29.512364'}], 'PENDING',
                           [{'id': 41428829, 'state': 'PENDING', 'date': '2019-07-03T18:35:29.512364'}]),
                          ([{'id': 41428829, 'state': 'FAILURE', 'date': '2019-07-03T18:35:29.512364'}], 'FAILURE',
